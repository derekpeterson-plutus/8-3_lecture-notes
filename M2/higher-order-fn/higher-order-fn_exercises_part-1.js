...
transform('left right left', function () {
  if (text === 'left') { return text.toUpperCase() }
  else if (text === 'right') { return text.toLowerCase()}
  else if (text === 'left right left') { return text.replaceAll(' ', '-') }
})