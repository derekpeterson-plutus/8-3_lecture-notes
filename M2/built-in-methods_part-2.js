...
function randomDecimal30To70(max, min) {
  return Math.random() * (max - min) + min;
}
for (let i = 0; i <=5; i++) {
console.log(randomDecimal30To70(70, 30))
}
 ...
 *
 * 1. for... in loop
 * 2. for... of loop ===> NEVER USE FOR OF LOOP IN OBJECT
...
function highestSalary(roles) {
  ...
  console.log('keys: ', Object.keys(roles)) //===> Output an array of strings of job titles
  console.log('values: ', Object.values(roles)) // ===> Output an array of numbers of salary
  console.log('entries: ', Object.entries(roles)) // ===> Output an array of arrays of key-value pairs

  for (let jobTitle in roles) {
    // console.log('The job title is: ', jobTitle)
    // console.log('The salary is: ', roles[jobTitle])
